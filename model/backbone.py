...
class Darknet53(nn.Module):
    ...
    It contains 53 convolutional layers and is also used in YOLO
    ...
    def __init__(self):
        ...
        self.residual_block1 = ResBlock(in_channels=64, num_blocks=1)
        ...
        self.residual_block2 = ResBlock(in_channels=128, num_blocks=2)
        ...
        self.residual_block3 = ResBlock(in_channels=256, num_blocks=8)
        ...
        self.residual_block4 = ResBlock(in_channels=512, num_blocks=8)
        ...
        self.residual_block5 = ResBlock(in_channels=1024, num_blocks=4)
        ...
        with open(weightfile, 'rb') as fp:
            ...
            for child in self.children():
                ...
                # immersion in residual blocks
                    ...
                    for residual_block in child.children():
